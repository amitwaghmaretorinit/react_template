...
export const dataTableTests = describe('DataTable Tests', () => {
    ...
    it('it should render DataTable', async () => {
        ...
        const tableColElements = screen.getAllByText((content, element: any) => element.tagName.toLowerCase() === 'td')
        const tableRowElements = screen.getAllByText((content, element: any) => element.tagName.toLowerCase() === 'tr')
